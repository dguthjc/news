...
<html>
  ...
  <body>
  	<form action="/news/newsServlet?type1=showPage" id="myform" method="post">
  	 <table align="center" border='1' cellspacing="0" cellpadding="3" style="margin-top: 20px;">
	    <tr bgcolor='#ccc'>
	    ...
	    <c:forEach items="${requestScope.news}"  var="news">      
	   		<tr id="content">
		   		...
		   		<td style="width: 40px;"><a href="/news/newsServlet?type1=details&newsId=${news.newsId}">查看</a></td>  
		   	</tr>
		</c:forEach> 	    
	</table>
	<div id="table2">
