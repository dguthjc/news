...
<html>
  <head>
	...
	<style>
		.items{
			float: left;margin-left: 3%;margin-top: 0.5%;
		}
		body {
  ...
  <body>
    <form action="/news/newsServlet?type1=showPersonalNews&page=1&pageSize=17&author=${user.name}" 
    	method="post" target="content_main">
			<div class="items">
				<span>类型</span>
				<span>
